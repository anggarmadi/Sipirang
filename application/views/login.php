...
<head>
  ...
  <title>Sistem Informasi Peminjaman Ruangan | <?php echo $title; ?></title>
...
<body class="hold-transition login-page" style="background: url('<?php echo base_url('assets/') ?>dist/img/ua.jpeg');">
